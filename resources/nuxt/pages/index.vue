<template>
    <v-container fluid id="dash-container">
        <div class="carousel-wrapper">
            <v-carousel cycle height="12.5rem" hide-delimiters :show-arrows="false">
            ...
            <div class="carousel-overlay">
                ...
                <p class="subtitle">We are a gaming community dedicated to research and development of sandbox
                    experiences.</p>
            </div>
        </div>
            ...
            <v-row align="center" justify="center">
                <v-col cols="12" md="8" lg="6">
                    <v-row>
                        ...
                        <v-col cols="12" sm="6" md="4">
                            <v-card class="server-card" tile>
                                <v-img src="/images/ts3.jpg" height="220">
                                    <div class="server-overlay">
                                        <div class="server-title">TS3</div>
                                        <div class="server-footer">
                                            <div class="server-left">
                                                <span class="status-dot"></span>
                                                <span>TS.SuperiorServers.co</span>
                                            </div>
                                            <div>45/256</div>
                                        </div>
                                    </div>
                        ...
                        <v-col cols="12" sm="6" md="4">
                            <v-card class="server-card" tile>
                                <v-img src="/images/danktown.jpg" height="220">
                                    <div class="server-overlay">
                                        <div class="server-title">Danktown</div>
                                        <div class="server-footer">
                                            <div class="server-left">
                                                <span class="status-dot"></span>
                                                <span>RP.SuperiorServers.co</span>
                                            </div>
                                            <div>35/128</div>
                                        </div>
                                    </div>
                        ...
                        <v-col cols="12" sm="6" md="4" v-for="(item, i) in jank" :key="i">
                            <v-card class="server-card" tile>
                                <v-img src="/images/danktown.jpg" height="220">
                                    <div class="server-overlay">
...
export default class IndexClass extends Vue {
    thing = 69;
    gmodServerModule: GModServersModule | null = null;
    items = [
        {
